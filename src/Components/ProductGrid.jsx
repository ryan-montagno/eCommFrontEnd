      ...
      {data && data.length > 0 ? (
        data.map((product) => (
          <div
            ...
            className="product-card bg-white border border-gray-200 p-1 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 cursor-pointer"
            onClick={() =>
              setSelectedProduct(
                selectedProduct &&
          ...
          >
            ...
            selectedProduct.product_id === product.product_id ? (
              <div className="p-4 flex flex-col items-start relative">
                ...
                <p className="text-sm text-gray-900 font-bold absolute top-4 right-4">
